				...
				?>
                  ...
                  <form  action="save-settings.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          ...
                          <img src="images/<?php echo $row['weblobo'];  ?>">
                          <input type="hidden" name="old_logo" value="images/<?php echo $row['weblobo'];  ?>" >
                      </div>
                      <div class="form-group">
                          <label for="footer_desc">Footer Description</label>
                          <textarea name="footer_desc" class="form-control" rows="5" required><?php echo $row['footerdiscri'];  ?></textarea>
                      </div>
